package com.wangsheng.SpringCrawler.config;
...
@EnableJpaRepositories(
        basePackages = "com.wangsheng.SpringCrawler",
...
public class JpaConfig {
    ...
    LocalContainerEntityManagerFactoryBean localContainerEntityManagerFactoryBean(@Qualifier(value = "EmbeddedDataSource") DataSource dataSource, JpaVendorAdapter jpaVendorAdapter) {
        ...
        localContainerEntityManagerFactoryBean.setPackagesToScan("com.wangsheng.SpringCrawler.entity");
